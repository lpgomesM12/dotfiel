...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { cep: @endereco.cep, cidade_id: @endereco.cidade_id, complento: @endereco.complento, endereco: @endereco.endereco, numero: @endereco.numero }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { cep: @endereco.cep, cidade_id: @endereco.cidade_id, complento: @endereco.complento, endereco: @endereco.endereco, numero: @endereco.numero }
    assert_redirected_to endereco_path(assigns(:endereco))
  end

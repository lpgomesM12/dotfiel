...
def show_cliente
     ...
     json_cliente =   {:id => @cliente.id,
                            ...
                            :data_nascimento => @cliente.pessoa.data_nascimento != nil ? @cliente.pessoa.data_nascimento.strftime("%d/%m/%Y") : '',
 ...
 def busca_cliente
  ...
  def lista_clientes
    ...
    json_clientes = @clientes.map { |item| {:id => item.id,
                                          ...
                                          :cpf => item.pessoa.cpf,
                                          :data_nascimento => item.pessoa.data_nascimento != nil ? item.pessoa.data_nascimento.strftime("%d/%m/%Y") : '',
